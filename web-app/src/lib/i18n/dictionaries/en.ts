...
export const en = {
  ...
  "profile.feedback.attachmentHint": "Any file type · 5 MB total",
  "profile.feedback.attachmentTotal": "used of 5 MB",
  "profile.feedback.attachmentTooLarge": "File too large — 5 MB total.",
