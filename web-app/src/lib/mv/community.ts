...
export const TRENDING_MVS: CommunityMv[] = [
  ...
  // Product owner, 2026-09-07: seven more entries so "Top Picks Music
  // Videos" (MvGridSections' desktop-only scroll row) actually overflows
  // at normal desktop widths and its Previous/Next arrows have something
  // to reveal — 3 items never filled even a 6-per-row width. Thumbnails
  // reuse NEW_MVS' own pool (same convention CREATOR_MVS already uses;
  // there are only 14 sample-mv images total, all already spoken for).
  {
    id: "trend-skyline-reverie",
    title: "Skyline Reverie",
    thumb: mv("mv_04_eletronic.jpg"),
    video: V_STORY,
    badge: "NEW",
    meta: "Storytelling · 2-3 min",
    prompt: "A dreamy skyline at dusk — soft city lights, quiet rooftop moments, wistful reflection.",
    mvType: "storytelling",
    creator: "SkylineDreamer",
    plays: 6200,
    likes: 1450,
    shares: 150,
    date: "2026-06-06",
  ...
  {
    id: "trend-electric-pulse",
    title: "Electric Pulse",
    thumb: mv("mv_09_urban_performer.jpg"),
    video: V_SINGING,
    badge: null,
    meta: "Singing · 1-2 min",
    prompt: "Raw stage energy under electric light — pounding rhythm, sweat and spotlight.",
    mvType: "singing",
    creator: "PulseRider",
    plays: 5400,
    likes: 1120,
  ...
  {
    id: "trend-golden-horizon",
    title: "Golden Horizon",
    thumb: mv("mv_06_cinematic_movie.jpg"),
    video: V_HYBRID,
    badge: null,
    meta: "Hybrid · 2-3 min",
    prompt: "A golden-lit horizon at sunrise — sweeping vistas, hopeful pacing, warm color grade.",
    mvType: "hybrid",
    creator: "HorizonChaser",
    plays: 4800,
    likes: 980,
    shares: 76,
    date: "2026-06-04",
  ...
  {
    id: "trend-crimson-tide",
    title: "Crimson Tide",
    thumb: mv("mv_10_monochrome.jpg"),
    video: V_STORY,
    badge: null,
    meta: "Storytelling · 3-4 min",
    prompt: "A crimson-drenched coastal story — crashing waves, dramatic silhouettes, slow-motion tension.",
    mvType: "storytelling",
    creator: "TideWalker",
    plays: 3600,
    likes: 720,
  ...
  {
    id: "trend-velvet-nights",
    title: "Velvet Nights",
    thumb: mv("mv_05_anime_style.jpg"),
    video: V_HYBRID,
    badge: null,
    meta: "Hybrid · 2-3 min",
    prompt: "Smooth velvet-toned nightlife — neon reflections, soft jazz mood, effortless style.",
    mvType: "hybrid",
    creator: "VelvetVibes",
    plays: 4100,
    likes: 890,
  ...
  {
    id: "trend-solar-flare",
    title: "Solar Flare",
    thumb: mv("mv_08_dramatic_scene.jpg"),
    video: V_SINGING,
    badge: "NEW",
    meta: "Singing · 1-2 min",
    prompt: "A blazing solar-flare aesthetic — searing color bursts, high-energy performance, bold contrast.",
    mvType: "singing",
    creator: "SolarStorm",
    plays: 2900,
    likes: 610,
